...
int main() {
 ...
 //     
	...
	glm::mat4 projection=glm::mat4(1); //todos los valores de esa matris estan en 1, al declararse ya no se agregan los tipos de datos
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		ourShader.Use();
		glm::mat4 model=glm::mat4(1); //ambsa de declaran e inicializan
		glm::mat4 view=glm::mat4(1);
	
	 view = glm::translate(view, glm::vec3(0.0f,0.0f,-12.0f));
		model = glm::rotate( model, 1.0f, glm::vec3( 1.0f, 1.0f, 0.0f ) ); 
		model = glm::translate(model, glm::vec3(5.0f, 5.0f, .0f));// use to compare orthographic and perspective projection
		...
		model = glm::rotate(model, -2.0f, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(6.0f, -5.0f, 0.0f));
		model = glm::rotate(model, -5.0f, glm::vec3(0.0f, 1.0f, 1.0f));
